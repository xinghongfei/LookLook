...
public class MainActivity extends Activity {
    ...
    @InjectView(R.id.stub_no_connection)
    ViewStub stubNoConnection;
    @InjectView(R.id.stub_posting_progress)
    ViewStub loading;
        ...
        public void onAvailable(Network network) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    noContectionText.setVisibility(View.GONE);
                    // TODO: 16/8/13  load  date
